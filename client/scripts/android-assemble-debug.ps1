...
if (-not $javaHome) {
  throw 'JAVA_HOME not found. Please install JDK 21 or update client/scripts/android-assemble-debug.ps1.'
}

if (-not $sdkRoot) {
  throw 'ANDROID_SDK_ROOT not found. Please install Android SDK or update client/scripts/android-assemble-debug.ps1.'
}
